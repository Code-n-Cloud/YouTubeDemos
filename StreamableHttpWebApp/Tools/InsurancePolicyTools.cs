...
{
    public class InsurancePolicyTools(StorageAccountBlobService storageAccountBlobService, ILogger<InsurancePolicyTools> logger, TextToSpeechService textToSpeechService)
    {
